...
module Proxy::OpenSCAP
  ...
  class Api < ::Sinatra::Base
    ...
    post "/oval_reports/:oval_policy_id" do
      # json = OvalReportParser.new.parse_cves(request.body.string).to_json

      foreman_response = ForemanOvalForwarder.new.post_report(@cn, params[:oval_policy_id], @reported_at, request.body.string, Plugin.settings.timeout)
